            ...
            <header className="sticky top-0 z-50 border-b border-app-border bg-app-card">
                <div className="flex h-16 items-center justify-between px-4">
                    <Sheet open={open} onOpenChange={setOpen}>
                        ...
                        <SheetContent side="left" className="w-72 p-0 bg-app-sidebar border-app-border">
                            <SheetHeader className="border-b border-app-border p-6">
                                <SheetTitle className="text-x1 text-white font-bold">
                                    Menu
                                </SheetTitle>
                            </SheetHeader>
                                ...
                                <nav className="flex flex-col p-4 space-y-4">
                                    ...
                                    return (
                                        <Link 
                                            ...
                                            key={menu.title}
                                            className={cn(
                                                "flex items-center gap-3 p-2 rounded-md text-gray-200 hover:bg-app-hover hover:text-white transition border-md transition-colors duration-300 text-white",
                    ...
                    <h1 className="text-lg font-bold">
                        <span className="block text-center">Augusto</span>
                        <span className="block text-center text-brand-primary">Hamburgueria</span>
                    </h1>
